...
/*   Updated: 2022/03/08 15:42:32 by eperaita         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	//ICharacter *clone = new Character(*ep); //clona una y otra vez hasta que peta. Porque? porque debe recibir tipo Character, no alojado 
	//Otra opcion frustrada:  Alojo un nuevo de tipo Character con su constructor de parametro y copio con el operador de asignacion. 
	/*ICharacter *clone = new Character("Clone");
	clone = ep;//no me hace la asignacion	*/
